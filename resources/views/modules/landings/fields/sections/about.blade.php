<x-form-section>
    <x-slot:labelText>{{ __('ui.about_section') }}</x-slot:labelText>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <x-media-upload-field id="landing_about_image" name="content[about][image]" :label="__('ui.about_image')" :path="data_get($content, 'about.image')"
