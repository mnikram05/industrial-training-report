<x-form-section>
    <x-slot:labelText>{{ __('ui.hero_section') }}</x-slot:labelText>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div class="min-w-0 space-y-4 rounded-lg border border-border p-3">
            <p class="text-xs font-medium uppercase tracking-wide text-muted-foreground">{{ __('ui.primary_button') }}</p>

            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <x-field for="landing_hero_primary_text_en" :error="$errors->first('content.hero.primary_button.text.en')" class="gap-1.5">
                    <x-slot:labelText>{{ __('ui.text_english') }}</x-slot:labelText>
                ...
                <x-field for="landing_hero_primary_text_ms" :error="$errors->first('content.hero.primary_button.text.ms')" class="gap-1.5">
                    <x-slot:labelText>{{ __('ui.text_malay') }}</x-slot:labelText>
            ...
            <x-field for="landing_hero_primary_url" class="gap-1.5">
                <x-slot:labelText>{{ __('ui.url') }}</x-slot:labelText>
        ...
        <div class="min-w-0 space-y-4 rounded-lg border border-border p-3">
            <p class="text-xs font-medium uppercase tracking-wide text-muted-foreground">{{ __('ui.secondary_button') }}
            </p>
